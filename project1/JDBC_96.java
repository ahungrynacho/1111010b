...
// http://theopentutorials.com/tutorials/java/JDBC_96/JDBC_96-mysql-CONNECTION-tutorial/

public class JDBC_96 {
	...
	public JDBC_96() throws Exception {
		/* Constructor */
	...
	public void login() {
		...
		while (true) {
			try {
				...
				JDBC_96.USER = JDBC_96.INPUT.nextLine();
				System.out.print("password: ");
				JDBC_96.PASSWORD = JDBC_96.INPUT.nextLine();
				this.CONNECTION = DriverManager.getConnection(JDBC_96.URL, 
															JDBC_96.USER, 
															JDBC_96.PASSWORD);
	...
	private String getFeaturedMovies() {
		...
		if (JDBC_96.INPUT.nextLine().equalsIgnoreCase("y")) {
			System.out.print("id: ");
			String id = JDBC_96.INPUT.nextLine();
		...
		if (JDBC_96.INPUT.nextLine().equalsIgnoreCase("y")) {
			...
			String firstName = JDBC_96.INPUT.nextLine();
			
			System.out.print("last_name: ");
			String lastName = JDBC_96.INPUT.nextLine();
	...
	private String addStar() {
		...
		if (JDBC_96.INPUT.nextLine().equalsIgnoreCase("y")) {
			System.out.print("first_name: ");
			firstName = JDBC_96.INPUT.nextLine();
			
			System.out.print("last_name: ");
			lastName = JDBC_96.INPUT.nextLine();		
		}
		else {
			firstName = "";
			System.out.print("last_name: ");
		...
		if (JDBC_96.INPUT.nextLine().equalsIgnoreCase("y")) {
			...
			dob = JDBC_96.INPUT.nextLine();
		}
		
		System.out.print("Photo URL (y/n): ");
		if (JDBC_96.INPUT.nextLine().equalsIgnoreCase("y")) {
			System.out.print("photo_url: ");
			photoUrl = JDBC_96.INPUT.nextLine();
		}
	...
	private String addCustomer() throws Exception {
		...
		String address = JDBC_96.INPUT.nextLine();
		
		System.out.print("email: ");
		String email = JDBC_96.INPUT.nextLine();
		
		System.out.print("password: ");
		String password = JDBC_96.INPUT.nextLine();
	...
	private void getMetadata() throws Exception {		
		...
		for (int i = 0; i < JDBC_96.TABLES.length; ++i) {
			ResultSet columns = metadata.getColumns(null, null, JDBC_96.TABLES[i], "%");
			System.out.println(JDBC_96.TABLES[i]);
	...
	public void run() {		
		 ...
		 * calling JDBC_96's privately defined methods. */
		...
		while (true) {
			...
			System.out.print("$ ");
			String command = JDBC_96.INPUT.nextLine();

			try {
				switch(command) {
					case "0":
						System.out.print("$ ");
						String query = JDBC_96.INPUT.nextLine();
